...
function test_connection(frm) {
	...
	frappe.call({
		method: "biometric_integration.biometric_integration.api.test_connection",
		args: {
...
function sync_attendance(frm) {
	...
	frappe.confirm(
		...
		function () {
			frappe.call({
				method: "biometric_integration.biometric_integration.api.sync_attendance_from_device",
				args: {
					device_ip: frm.doc.device_ip,
					device_port: frm.doc.device_port || 4370,
				},
...
function sync_employees(frm) {
	...
	frappe.confirm(
		...
		function () {
			frappe.call({
				method: "biometric_integration.biometric_integration.api.sync_employees_to_device",
				args: {
					device_ip: frm.doc.device_ip,
					device_port: frm.doc.device_port || 4370,
				},
...
function clear_device_logs(frm) {
	...
	frappe.confirm(
		...
		function () {
			frappe.call({
				method: "biometric_integration.biometric_integration.api.clear_device_logs",
				args: {
					device_ip: frm.doc.device_ip,
					device_port: frm.doc.device_port || 4370,
				},
...
function get_device_users(frm) {
	...
	frappe.call({
		method: "biometric_integration.biometric_integration.api.get_device_users",
		args: {
			device_ip: frm.doc.device_ip,
			device_port: frm.doc.device_port || 4370,
		},
...
function get_device_info(frm) {
	...
	frappe.call({
		method: "biometric_integration.biometric_integration.api.get_device_info",
		args: {
			device_ip: frm.doc.device_ip,
			device_port: frm.doc.device_port || 4370,
		},
